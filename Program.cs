...
#pragma warning restore CS8604 // Possible null reference argument.
   ...
   void OutofPortChoice(string choice)
    ...
    void Shop()
    {
        ...
        while (true)
        {
            Console.WriteLine($"----------------------------------------------------------------------------------------------------------------\nI                  Welcome to the Shop               I                            Stats                        I\nI       Options                                      I Health: {playerShip.Health}/{playerShip.MaxHealth}      I\nI       1. Buy cannons (1000 coins)                  I Cannons:{playerShip.Cannons/player.Ship.MaxCannons}     I\nI       2. Buy crew members (100 coins)              I Crew: {playerShip.Crew}/{playerShip.MaxCrew}            I\nI       3. Upgrade ship (5000 coins)                 I Gold: {playerShip.Bank}                                 I\nI       4. Sell captured ship (1000 coins)           I Captured ships: {playerShip.Items}                      I\nI       5. Leave shop                               I                                                        I\n---------------------------------------------------------------------------------------------------------------- ");
            string choice = Console.ReadLine();
#pragma warning disable CS8604 // Possible null reference argument.
